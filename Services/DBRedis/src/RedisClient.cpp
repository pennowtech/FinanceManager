...
RedisDB::RedisDB(QObject* parent)
    : QObject(parent), m_enableCaching(false) {
    m_redisStatus = "Disconnected";
}

QString RedisDB::cassandraStatus() const { return m_cassandraStatus; }

QString RedisDB::redisStatus() const { return m_redisStatus; }
