...
void forwardRequestToExpensesService(const drogon::HttpRequestPtr &req, const drogon::HttpResponsePtr &resp,
...
int main(int argc, char *argv[]){
    ...
    std::cout << "Api Gateway Service App\n";

    std::string projectId = DCS_FIREBASE_PROJECT_ID;
